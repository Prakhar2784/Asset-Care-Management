...
const ACTION_META = {
  ...
  asset_updated:         { label: 'Asset Updated',         color: '#7777C7', bg: 'rgba(119, 119, 199, 0.18)' },
  ...
  asset_revoked:         { label: 'Asset Revoked',         color: '#7777C7', bg: 'rgba(119, 119, 199, 0.18)' },
  ...
  user_updated:          { label: 'User Updated',          color: '#7777C7', bg: 'rgba(119, 119, 199, 0.18)' },
};
...
const ROLE_COLORS = { admin: '#111827', hod: '#A78BFA', employee: '#60A5FA', vendor: '#7777C7' };
