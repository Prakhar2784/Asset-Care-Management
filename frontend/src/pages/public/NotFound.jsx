...
export default function NotFound() {
  return (
    <Box sx={{
      ...
      textAlign: "center", px: 3, bgcolor: "#080812",
      backgroundImage: "radial-gradient(ellipse at 15% 0%, rgba(124,58,237,0.18) 0%, transparent 50%), radial-gradient(ellipse at 85% 100%, rgba(168,85,247,0.12) 0%, transparent 50%)",
    }}>
      <Box>
        <Typography sx={{
          fontSize: { xs: 90, md: 140 }, fontWeight: 950, lineHeight: 1,
          letterSpacing: "-4px", color: "rgba(168,85,247,0.14)",
        }}>
          404
        </Typography>
        ...
        <Typography sx={{ color: "#8B8BAA", fontSize: 16, maxWidth: 420, mx: "auto", mb: 4, lineHeight: 1.7 }}>
          The page you're looking for doesn't exist or may have been moved.
        </Typography>
        <Box sx={{ display: "flex", gap: 2, justifyContent: "center", flexWrap: "wrap" }}>
          <Button component={Link} to="/" variant="contained" startIcon={<HomeRounded />}
            sx={{
              background: "linear-gradient(135deg,#7C3AED,#A855F7)", color: "#fff", fontWeight: 800,
              px: 3.5, py: 1.4, borderRadius: "12px", boxShadow: "0 4px 16px rgba(124,58,237,0.4)",
