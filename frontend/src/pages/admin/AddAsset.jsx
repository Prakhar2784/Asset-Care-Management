    ...
    <Box sx={{ width: "100%", pb: 6 }}>
      ...
      <Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2, flexWrap: "wrap" }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, flexShrink: 0 }}>
              ...
              <Button
                ...
                sx={{
                  background: "#7777C7", color: "#FFFFFF",
          ...
          <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 2, mb: 3 }}>
            ...
            {docCount > 0 && (
              <Chip label={`${docCount} file${docCount > 1 ? "s" : ""} attached`}
                size="small" sx={{ background: "#7777C7", color: "#FFFFFF", fontWeight: 800, fontSize: 11 }} />
            )}
          </Box>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 2, flexWrap: "wrap" }}>
          ...
          <Button type="submit" variant="contained" disabled={loading}
            ...
            sx={{ background: "#7777C7", color: "#FFFFFF", fontWeight: 800, borderRadius: "12px", boxShadow: "none", px: 4, py: 1.4, fontSize: 15, "&:hover": { background: "#6464B8", boxShadow: "none" } }}>
      ...
      <Dialog open={emptyFieldsDialog} onClose={() => setEmptyFieldsDialog(false)} maxWidth="xs" fullWidth
        ...
        <DialogActions sx={{ px: 3, pb: 2, pt: 1, gap: 1 }}>
          ...
          <Button onClick={() => { setEmptyFieldsDialog(false); handleSubmit(null, true); }} variant="contained" sx={{ background: "#7777C7", color: "#FFFFFF", fontWeight: 800, borderRadius: "10px", flex: 1, boxShadow: "none", textTransform: "none" }}>
            Register Anyway
          </Button>
        </DialogActions>
      </Dialog>
