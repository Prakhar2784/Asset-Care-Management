...
const Features = () => {
  ...
  const data = [
    ...
    ["Service Requests", "Raise service requests for damaged or faulty assets with priority and issue details.", <BuildIcon fontSize="large" />, "/tickets"],
    ...
    ["Service History", "Maintain full repair history, resolution details, technician notes and closure remarks.", <HistoryIcon fontSize="large" />, "/tickets"],
    ["Reports", "Generate department-wise, warranty-wise, vendor-wise and request reports.", <ReportIcon fontSize="large" />, "/admin/dashboard"],
  ];
  ...
  return (
    <>
      <style>{`
        ...
        .feat-text { font-size: 15px; line-height: 1.65; color: #879A91; flex: 1; font-weight: 500; }

        .feat-link {
          margin-top: 26px;
          display: inline-flex; align-items: center; gap: 7px;
          font-weight: 800; font-size: 13.5px; color: #B4F105;
        }
        ...
        .cta-btn:hover { transform: translateY(-3px); box-shadow: 0 12px 24px rgba(180,241,5,0.3); }
        ...
        <div className="features-hero">
          <div className="features-container">
            <div style={{ marginBottom: 32 }}>
              ...
              <p style={{ color: '#CBD5E1', fontSize: 17, fontWeight: 500, lineHeight: 1.7, maxWidth: 640, margin: 0 }}>IAssetCare is designed for companies that want proper tracking of assets, service requests, warranties and approvals.</p>
            </div>
